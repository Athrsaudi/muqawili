...
export default function FileViewer({files=[],title='المرفقات'}){
  ...
  return(
    <div className="file-viewer">
      ...
      {lb&&(
        <div className="file-lightbox" onClick={()=>setLb(null)}>
          <img src={lb} alt="preview" className="file-lightbox-img"/>
          <button className="file-lightbox-close" onClick={()=>setLb(null)}>✕</button>
        </div>
      )}
    </div>
  )
